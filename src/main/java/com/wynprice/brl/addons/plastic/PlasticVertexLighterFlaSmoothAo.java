...
public class PlasticVertexLighterFlaSmoothAo extends VertexLighterSmoothAo
{

	public PlasticVertexLighterFlaSmoothAo(BlockColors colors) {
		super(colors);
	}
    ...
    protected void processQuad()
    {
        ...
        if(tint != -1)
        {
        	if(BufferedPlastic.plastic ? !Lists.newArrayList
        			(
        					Blocks.WATER,
        					Blocks.FLOWING_WATER,
        					Blocks.DOUBLE_PLANT
        			).contains(blockInfo.getState().getBlock()) : true)
        	multiplier = blockInfo.getColorMultiplier(0);
        }
