...
public class UVTransformer implements IClassTransformer
{
	...
	public byte[] transform(String name, String transformedName, byte[] basicClass) 
	{
        ...
        LocalVariableNode faceData = new LocalVariableNode(CloakCore.isDebofEnabled ? "p_178404_1_" : "faceData", "[I", null, startLabel, endLabel, 0);
        LocalVariableNode storeIndex = new LocalVariableNode(CloakCore.isDebofEnabled ? "p_178404_2_" :"storeIndex", "I", null, startLabel, endLabel, 1);
        LocalVariableNode vertexIndex = new LocalVariableNode(CloakCore.isDebofEnabled ? "p_178404_3_" : "vertexIndex", "I", null, startLabel, endLabel, 2);
        LocalVariableNode position = new LocalVariableNode(CloakCore.isDebofEnabled ? "p_178404_4_" : "position", "Lorg/lwjgl/util/vector/Vector3f;", null, startLabel, endLabel, 3);
        LocalVariableNode shadeColor = new LocalVariableNode(CloakCore.isDebofEnabled ? "p_178404_5_" : "shadeColor", "I", null, startLabel, endLabel, 4);
        LocalVariableNode sprite = new LocalVariableNode(CloakCore.isDebofEnabled ? "p_178404_6_" : "sprite", "Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;", null, startLabel, endLabel, 5);
        LocalVariableNode faceUV = new LocalVariableNode(CloakCore.isDebofEnabled ? "p_178404_7_" : "faceUV", "Lnet/minecraft/client/renderer/block/model/BlockFaceUV;", null, startLabel, endLabel, 6);
        ...
        storeVertexData.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/wynprice/cloak/common/core/UVTransformer", "storeVertexData", "([IIILorg/lwjgl/util/vector/Vector3f;ILnet/minecraft/client/renderer/texture/TextureAtlasSprite;Lnet/minecraft/client/renderer/block/model/BlockFaceUV;)V", false));
